...
2. Once the MIT AI2 Companion app is installed, open it. Then go to the "Connect" dropdown found once signed in to the MIT App Inventor page, *Please note you should have the project opened in there at this point.* Click on "Connect", then "AI Companion", then either type the code shown there in to the MIT AI2 Companion app or scan the QR with the same app that is shown.

3. Once step 2 is complete the app should be displayed on your device, you can then test the functionality.
...
*Please note you should hide "Phone 1" out of sight so it is not easily found.*